        ...
        if (perfilOriginal.id !== existingAuthUser.id) {
          const { error: cloneErr } = await supabaseAdmin
            ...
            .insert([{
              ...
              nombres: perfilOriginal.nombres,
              apellidos: perfilOriginal.apellidos,
              documento_identidad: perfilOriginal.documento_identidad,
              fecha_nacimiento: perfilOriginal.fecha_nacimiento || null,
              telefono: perfilOriginal.telefono || null,
              email_contacto: cleanEmail,
              direccion: perfilOriginal.direccion || null,
              acudiente_nombre: perfilOriginal.acudiente_nombre || null,
              acudiente_identificacion: perfilOriginal.acudiente_identificacion || null,
              tipo_sangre: perfilOriginal.tipo_sangre || null,
              eps: perfilOriginal.eps || null,
              patologias: perfilOriginal.patologias || null,
              talla_uniforme: perfilOriginal.talla_uniforme || null,
              posicion: perfilOriginal.posicion || null,
              categoria_id: perfilOriginal.categoria_id || null,
              grupos: perfilOriginal.grupos || null,
              estado_miembro: 'Activo',
              rol: perfilOriginal.rol || 'Futbolista',
              tipo_plan: perfilOriginal.tipo_plan || null,
              emergencia_nombre: perfilOriginal.emergencia_nombre || null,
              emergencia_telefono: perfilOriginal.emergencia_telefono || null,
              hijos_config: perfilOriginal.hijos_config || null,
              club_id: perfilOriginal.club_id,
              fecha_ingreso_club: perfilOriginal.fecha_ingreso_club || null,
              foto_url: perfilOriginal.foto_url || null,
              doc_jugador_url: perfilOriginal.doc_jugador_url || null,
              doc_eps_url: perfilOriginal.doc_eps_url || null,
              doc_acudiente_url: perfilOriginal.doc_acudiente_url || null,
              doc_extra_url: perfilOriginal.doc_extra_url || null,
              estado_pago: perfilOriginal.estado_pago || null,
              fecha_inactivacion: perfilOriginal.fecha_inactivacion || null,
            }]);
